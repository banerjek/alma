...
function get_country_code  {
	...
	s/BEGIN_COUNTRYgb<END_COUNTRY/BEGIN_COUNTRYUK<END_COUNTRY/i # UK
	s/BEGIN_COUNTRY[^<]*uni[^ ]* \?k[^<]*<END_COUNTRY/BEGIN_COUNTRYUK<END_COUNTRY/i # UK
	s/BEGIN_COUNTRY[^<]*u[\. ]*k[\. ]*<END_COUNTRY/BEGIN_COUNTRYUK<END_COUNTRY/i # UK
	s/BEGIN_COUNTRY[^<]*britain[^<]*<END_COUNTRY/BEGIN_COUNTRYUK<END_COUNTRY/i # UK
	s/BEGIN_COUNTRY[^<]*scotland[^<]*<END_COUNTRY/BEGIN_COUNTRYUK<END_COUNTRY/i # UK
